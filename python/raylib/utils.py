...
def hex_to_rgba(hex_str: str) -> p.Color:
    ...
    if len(hex_str) == 8:
        ...
        r_str: str = hex_str[0] + hex_str[0]  # str concatenation
        g_str: str = hex_str[1] + hex_str[1]  # str concatenation
        b_str: str = hex_str[2] + hex_str[2]  # str concatenation
    else:
        raise ValueError("Incorrect hex color format")
    ...
    color: p.Color = p.color_alpha(p.Color(r, g, b), a)
