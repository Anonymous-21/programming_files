...
class Game_Manager:
    def __init__(self, pieces_spritesheet) -> None:
        ...
        self.black_pawn2 = pieces.Black_Pawn(
            pieces_spritesheet, BLOCK_SIZE, BLOCK_SIZE
        )
