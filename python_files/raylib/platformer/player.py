...
class Player:
    def __init__(self, sprite_dict, spritesheet) -> None:
        ...
        self.frames_speed = 10
        self.frame_num = 1
        self.current_frame = sprite_dict[self.alien_green[self.frame_num]]
        self.width = self.current_frame[2]
        self.height = self.current_frame[3]
        self.x_window = self.width - 100
        self.y_window = r.GetScreenHeight() - self.height
    ...
    def update(self):
        ...
        self.current_frame = self.sprite_dict[self.alien_green[self.frame_num]]
