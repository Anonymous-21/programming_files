...
while not window_should_close():
    ...
    if check_collision_point_triangle((x_window, y_window),
                                      triangle[1],
                                      triangle[2],
                                      triangle[3]):
        draw_text("collision detected",
                  600,
                  100,
                  30,
                  GRAY)
    elif check_collision_point_triangle((x_window + plane_width, y_window),
                                      triangle[1],
                                      triangle[2],
                                      triangle[3]):
        draw_text("collision detected",
                  ...
                  30,
                  GRAY)
    elif check_collision_point_triangle((x_window, y_window + plane_height),
                                      triangle[1],
                                      triangle[2],
                                      triangle[3]):
        draw_text("collision detected",
                  ...
                  30,
                  GRAY)
    elif check_collision_point_triangle((x_window + plane_width, y_window + plane_height),
                                      triangle[1],
                                      triangle[2],
                                      triangle[3]):
        draw_text("collision detected",
